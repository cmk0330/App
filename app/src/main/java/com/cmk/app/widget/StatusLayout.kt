 ...
 */
open class StatusLayout constructor(protected var mContext: Context, attrs: AttributeSet? = null) :
    ViewAnimator(mContext, attrs) {

    private var onLayoutChangeListener: ((View, String) -> Unit)? = null
    ...
    companion object {
        ...
        fun setGlobalData(list: List<StatusConfig>) {
            list.forEach {
                mGlobalStatusConfigs[it.status] = it
            }
        }
    ...
    fun setLayoutClickListener(listener: ((View, String) -> Unit)) {
