package com.cmk.app.util.permission
...
import com.sembozdemir.permissionskt.PermissionsMap
 ...
 */
fun FragmentActivity.askPermissions(vararg permissions: String, callbacks: PermissionCallbacksDSL.() -> Unit) {
 ...
 */
fun FragmentActivity.handlePermissionsResult(requestCode: Int,
